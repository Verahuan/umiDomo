...
import {InputChange,ClickChange,ClickDelete,RequestDate } from "@/store/actionCreators"
...
class ToDoList extends Component{
 ...
 render() {
  ...
  componentDidMount(){
    axios.get("http://www.tianqiapi.com/api?version=v9&appid=23035354&appsecret=8YvlPNrz").then((res)=> {
      console.log(res)
    })
